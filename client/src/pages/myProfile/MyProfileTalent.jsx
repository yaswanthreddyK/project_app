            ...
            {profile.workExperience.map((experience, index) => (
              <Card key={index} className={classes.card}>
                <CardContent>
                  ...
                  <Typography variant="subtitle1" className='font-Neue-roman'>{experience.description}</Typography>
                    <Typography variant="body2"  className='font-Neue-roman'>{experience.startDate?.split('T')[0]}</Typography>
