...
const ClientSettings = () => {
  ...
  const [selectedTags, setSelectedTags] = useState(profile.organisationType);
  const [formEntries, setFormEntries] = useState(profile.activities);
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("activities", JSON.stringify(formEntries));
    formData.append("projects", JSON.stringify(projects));
    formData.append('organisationType',JSON.stringify(selectedTags))
