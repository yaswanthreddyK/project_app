...
const ContractPreviewModalTalent = ({contract}) => {
        ...
        <div>
            ...
            <div>
                ...
                <div className='light cover-letter flex'>
                  <div>
                  <img src={contract.company_details[0].profileImage} alt=""  className="invites-image"/>
                  </div>
                  {contract.company_details[0].fullName}
                  </div>
            </div>
            <div >
...
export default ContractPreviewModalTalent;
